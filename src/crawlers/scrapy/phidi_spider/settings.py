...
USER_AGENT = _config.http.user_agent if (_CONFIG_LOADED and _config) else "Mozilla/5.0 (compatible; PhidiCrawler/1.0)"
...
# Feed exports (disabled - using custom pipeline)
FEEDS = {}
